...
#
# Parameters:
#   namevar   - The basename for the logfile. It'll actually be called
#               "/var/log/collectd_${namevar}.log"
#   level     - The collectd loglevel
#   timestamp - 'true' (default) or 'false'; whether to add timestamps to the
#               log
